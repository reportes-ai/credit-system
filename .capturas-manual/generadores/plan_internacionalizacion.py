# -*- coding: utf-8 -*-
"""Plan de Internacionalización — Business Suite a Ecuador y Bolivia."""
...
def construir():
    ...
    p(doc, 'Versión 1.0 · Septiembre 2026 — CONFIDENCIAL', size=11, align=WD_ALIGN_PARAGRAPH.CENTER, color=GRIS_SUAVE)
    p(doc, 'AutoFácil Crédito Automotriz — uso interno del Grupo', size=10, align=WD_ALIGN_PARAGRAPH.CENTER, color=GRIS_SUAVE)
    ...
    regla(doc, 'El levantamiento termina con un DOCUMENTO DE ALCANCE firmado con la gerencia local: qué '
               ...
               'local comprometida, el proyecto repite la historia de Full Credit: 3 años sin instalar.')
    ...
    p(doc, 'La inversión dominante es TIEMPO: el levantamiento, la localización y el acompañamiento de la '
           'marcha blanca. Con el equipo actual (Patricio + la Suite asistida por IA) el desarrollo no '
