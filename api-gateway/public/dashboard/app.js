...
function buildRentabTablePL() {
  ...
  document.getElementById('kpi2-pl').innerHTML = `
    ...
    <div class="kpi-box highlight"><div class="kpi-label">Ing. Neto AutoFácil</div><div class="kpi-val big">${fM(totIN_F)}</div><div class="kpi-sub">${tot.fin?(totIN_F/tot.fin*100).toFixed(1)+'%':''}</div></div>`;
