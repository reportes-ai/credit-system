...
const PLACEMENT_ITEMS = {
  ...
  'ia-pregunta':             { section:'reporteria',   href:'/ia/pregunta/',      icon:'bi-chat-dots',              titulo:'Pregúntale a AutoFácil' },
  ...
  'parques':                 { section:'mantenedores',  href:'/mantenedores/parques/',            icon:'bi-p-circle',               titulo:'Arriendos y Comisiones Parque y Calle' },
  ...
  'bd-clientes':             { section:'mantenedores',  href:'/mantenedores/bd-clientes-edicion/',               icon:'bi-database',               titulo:'BD Clientes' },
  'bd-operaciones':          { section:'mantenedores',  href:'/mantenedores/bd-operaciones-edicion/',            icon:'bi-database-gear',          titulo:'BD Operaciones' },
  'bd-antecedentes':         { section:'mantenedores',  href:'/mantenedores/bd-antecedentes-edicion/',           icon:'bi-briefcase-fill',          titulo:'BD Antecedentes Laborales' },
  'bd-inf-comercial':        { section:'mantenedores',  href:'/mantenedores/bd-informacion-comercial-edicion/',  icon:'bi-building-fill',           titulo:'BD Información Comercial' },
...
const PLACEMENT_DESCS = {
  ...
  'parques':'Arriendo y comisión por parque, y comisión dealer por plazo (parque y calle)',
  ...
  'bono-jefe':'Cálculo del bono BSC del Jefe Comercial: metas, topes y curva',
  // Mantenedores (cards que antes salían sin subtítulo)
  'bd-operaciones-edicion':'Edición directa de la tabla de operaciones (según nivel de editor)',
  'bd-clientes-edicion':'Edición directa de la tabla de clientes',
  'bd-antecedentes-edicion':'Edición directa de antecedentes laborales',
  'bd-informacion-comercial-edicion':'Edición directa de información comercial',
  'meses-cerrados':'Candado por mes: bloquea ediciones de periodos cerrados',
  'dealernet-productos':'Productos consultables de la integración DealerNet',
  'dealernet-costos':'Costo por consulta de la integración DealerNet',
  'certificados-textos':'Textos paramétricos de los certificados emitidos',
  'cobranza-mora':'Correos y WhatsApp automáticos por tramo de mora (Ley 21.320)',
  'tickets-ti':'Motivos, SLA y escalamiento de los tickets TI',
  'recalculo-programado':'Recálculo automático nocturno de operaciones',
  'rrhh-saludos':'Saludos de cumpleaños y textos de certificados RRHH',
  'ranking-ventas':'Ranking mensual de colocaciones por ejecutivo',
  'carrera':'La carrera de colocaciones: avance animado del mes',
  'mi-dia':'Configura los widgets del panel Mi Día por perfil',
  'documentacion':'Los documentos vivos del sistema: manual, procesos, técnica y brochure',
  'horarios-analistas':'Turnos y horarios de los analistas de crédito',
  'punto-restauracion':'Marca UAT: restaura créditos al punto guardado (Solo Dios)',
  'cobranza-judicial':'Catálogos de cobranza judicial: tribunales, estados y abogados',
  'preaprobacion':'Variables de la preaprobación automática (portal dealer y WhatsApp)',
  'remuneraciones':'UF, UTM, topes imponibles y tramos de impuesto único',
  // Tesorería (cards que antes salían sin subtítulo)
  ...
  'bitacora':'Bitácora de transacciones de tesorería',
  'conciliacion-bancaria':'Cartola bancaria vs sistema: matching automático de abonos',
  'cierre-mes':'Checklist de cierre de mes con responsables, recordatorios y candado',
};
