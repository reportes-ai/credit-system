...
app.use('/api/excepciones',             require('../../services/excepciones/src/routes/excepciones.routes'));
...
app.use('/api/empresa',              require('../../services/mantenedores/src/routes/empresa.routes'));   // Datos de la Empresa (fuente única)
...
app.use('/api/anulaciones',         require('../../services/creditos/src/routes/anulaciones.routes'));
...
require('../../services/auditoria/src/guardian-consistencia'); // cifras (ops/montos/rentabilidad) consistentes entre pantallas + aviso si divergen
...
const PAGINAS = [
  ...
  ['/mantenedores/empresa', 'mantenedores/empresa/index.html'],
  ...
  ['/mantenedores/endpoints', 'mantenedores/endpoints/index.html'],
  ...
  ['/postventa/orden-pago-parque', 'postventa/orden-pago-parque/index.html'],
  ...
  ['/fundantes-seguimiento/bitacora-atrasados', 'fundantes-seguimiento/bitacora-atrasados.html'],
  ...
  ['/contabilidad/cluster-pg', 'contabilidad/cluster-pg/index.html'],
  ['/contabilidad/guardian', 'contabilidad/guardian/index.html'],
  ['/contabilidad/punto-restauracion', 'contabilidad/punto-restauracion/index.html'],
  ['/contabilidad/directorio', 'contabilidad/directorio/index.html'],
  ...
  ['/recursos-humanos/colaboradores', 'recursos-humanos/colaboradores/index.html'],
  ...
  ['/recursos-humanos/aumento-renta', 'recursos-humanos/aumento-renta/index.html'],
  ...
  ['/recursos-humanos/remuneraciones/adicionales', 'recursos-humanos/remuneraciones/adicionales/index.html'],
  ['/recursos-humanos/remuneraciones/descuentos', 'recursos-humanos/remuneraciones/descuentos/index.html'],
  ['/recursos-humanos/licencias', 'recursos-humanos/licencias/index.html'],
  ...
  ['/academia/donde-como-quien', 'academia/donde-como-quien/index.html'],
];
