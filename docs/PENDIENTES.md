...
| 2.9 | **Precio DealerNet del Boletín Deudores de Pensión de Alimentos (código 2101)** (07-09-2026) | El 07-09 se cargaron desde la "TABLA Propuesta de Servicios DealerNET" los 6 productos que estaban en 0 (110, 107, 16, 3901, 3440, 3408). El **2101 no viene en esa tabla** y es el 2° producto más consultado (365 informes en sep-26): sigue en 0 UF en los 4 tramos, así que la pestaña Facturación y la Auditoría de uso lo valorizan en $0 y la recomendación de plan queda subvalorada. **Pedir la tarifa a DealerNet** y cargarla en Mantenedores → Costo DealerNet. |
