...
| 8b | Kardex de vacaciones, 1,25 días por mes (proporcional por días desde 14-09-2026); finiquito = saldo × sueldo/30 | Cuenta corriente `rh_vac_movimientos` (devengo 15 días por aniversario + progresivo art. 68 + tomados + ajustes), `saldoCuenta(id, fecha)`; el finiquito paga el saldo con la base de `services/rrhh/src/base-remuneracion.js`. | ✅ |
| 8c | Base del feriado proporcional y de las indemnizaciones con renta variable: art. 71 CT "promedio de lo ganado en los últimos tres meses trabajados"; DT: por **devengo** (la comisión se gana con la venta aunque se pague al mes siguiente), meses **completos**, y la gratificación mensual garantizada integra la base. | `base-remuneracion.js` (15-09-2026): sueldo y gratificación del mes M + comisiones, semana corrida y bonos **pagados en M+1**; si M+1 aún no se pagó, la comisión devengada la da el motor de Comisiones (Nómina vigente o cálculo). Excluye el mes de ingreso si no empezó el día 1 y el mes del término. Caso F. Contreras: base $1.947.837 (jun/jul/ago) — antes $1.631.580 por caja. | ✅ |
