...
| 1b | UF "del último día del mes a procesar" | `indicadores(mes)` toma la UF del **día 28** del mes (fallback: hoy). | ⚠️ pendiente 4.12 |
...
| 5b | Tope de gratificación proporcional a los días pagados (licencias/ausencias) | El tope se aplica **completo** aunque el mes tenga menos de 30 días pagados. | ⚠️ pendiente 4.12 |
| 6 | Topes imponibles (AFP/salud/SIS y AFC) proporcionales a los días pagados | Topes aplicados completos (`rem_tope_imponible_uf × UF`, `rem_tope_afc_uf × UF`) sin prorratear por licencias. | ⚠️ pendiente 4.12 |
...
1. Prorrateo por días pagados del **tope de gratificación** y de los **topes imponibles** (AFP/salud/SIS y AFC) cuando hay licencia médica o ausencias.
...
4. **UF de la liquidación**: hoy día 28 del mes; la norma usa el último día del mes.
