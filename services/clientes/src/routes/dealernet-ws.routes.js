...
// Telemetría del render (sección con datos sin formato propio): cualquier sesión válida
...
// Alertas de uso (patrones sospechosos): funcionalidad `dealernet_alertas`, asignada solo a Administrador
router.get('/informes/alertas',         verifyToken, requireFunc('dealernet_alertas'), C.alertas);
