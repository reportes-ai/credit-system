  ...
  try {
    ...
    if (!hayModelos.n) {
      ...
      const anterior = { ...actual,
        ...
        semana_corrida_calc: 1, semana_corrida: 1.1667, dctos_activo: 0,   // semana corrida por mes también en el modelo anterior (Pato, 07-09-2026)
        tramo_24_tasa_menor: 1, calidad_proporcional: 1, bono_sobre_base_total: 1 };   // calidad proporcional a la meta (Pato, 07-09-2026)
      ...
      await pool.query('INSERT IGNORE INTO comisiones_modelos (nombre, descripcion, valores, es_sistema, creado_por) VALUES (?,?,?,1,?)',
        ['Modelo anterior (hasta jul-2026)', 'Piso $30M, 24 cuotas pagan 0,75% (≤ 24), cesantía 50% / reparaciones 30% / calidad 20% (UNIDAD ÷ meta 3, proporcional) con umbrales 65/50, sin RDH, bonos sobre el incentivo base total, semana corrida calculada por mes (art. 45 CT), sin descuentos por prepago.', JSON.stringify(anterior), 'Sistema']);
    }
