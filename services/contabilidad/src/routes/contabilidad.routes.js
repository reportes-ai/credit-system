...
router.get('/libro-mayor-completo', verifyToken, requireFunc('ctb_libros', 'ctb_balance'), ctrl.libroMayorCompleto);
...
router.get('/comercial-directorio',    verifyToken, requireFunc('ctb_directorio', 'ctb_cierre_mes', 'ctb_estados'), ctrl.getComercialDirectorio);
router.get('/macro-directorio',        verifyToken, requireFunc('ctb_directorio', 'ctb_cierre_mes', 'ctb_estados'), ctrl.getMacroDirectorio);
...
router.get('/finanzas-ia/lecciones',    verifyToken, requireFunc('ctb_finanzas_ia'), require('../controllers/finanzas-ia.controller').getLecciones);
router.post('/finanzas-ia/lecciones',   verifyToken, requireFunc('ctb_finanzas_ia'), require('../controllers/finanzas-ia.controller').crearLeccion);
router.put('/finanzas-ia/lecciones/:id', verifyToken, requireFunc('ctb_finanzas_ia'), require('../controllers/finanzas-ia.controller').toggleLeccion);
...
router.post('/presupuesto/importar', verifyToken, requireFunc('ctb_presupuesto', 'ctb_directorio'), ctrl.importarPresupuesto);
...
router.get('/libros-legales/carpeta.zip',         verifyToken, requireFunc('ctb_libros_legales'), libros.carpetaZip);
router.get('/libros-legales/:codigo.xlsx',        verifyToken, requireFunc('ctb_libros_legales'), libros.libroXlsx);
router.get('/libros-legales/:codigo',             verifyToken, requireFunc('ctb_libros_legales'), libros.libro);
...
router.get('/dj/1887',     verifyToken, requireFunc('ctb_dj'), ctrl.getDJ1887);
