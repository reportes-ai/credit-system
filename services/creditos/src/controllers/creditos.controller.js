...
const create = async (req, res) => {
  try {
    ...
    `, [
      ...
      plazo || null, require('../../../../api-gateway/public/js/rentabilidad-core').normTasaMensualPct(tasa_mensual) || null, cuota || null, fecha_primera_cuota || null,
  ...
  try {
    ...
    if (esEdicionCompleta) {
      ...
      `, [
        ...
        valor_vehiculo || null, pie || null, saldo || null, pct || null, monto_financiado || null,
        plazo || null, require('../../../../api-gateway/public/js/rentabilidad-core').normTasaMensualPct(tasa_mensual) || null, cuota || null,
