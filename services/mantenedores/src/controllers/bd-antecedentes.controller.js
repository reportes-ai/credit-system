...
const TABLE = 'antecedentes_laborales';
const PK    = 'id';
const DATE_FIELDS = ['created_at', 'updated_at'];
const COL_ORDER   = ['id', 'rut_cliente', 'tipo_trabajador', 'empleador', 'rut_empresa',
  'renta_fija_liquida', 'antiguedad_meses'];
...
const update = async (req, res) => {
  try {
    ...
    auditar({ req, accion: 'EDITAR', modulo: 'mantenedores', entidad: 'antecedentes_laborales', entidad_id: id, detalle: `Editó antecedentes laborales (registro #${id}) desde BD`, meta: { campos: Object.keys(body) } });
