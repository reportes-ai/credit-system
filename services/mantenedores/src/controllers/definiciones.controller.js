...
require('../../../../shared/migrate').enFila('definiciones', async () => {
  try {
    const KB = [
      ...
      ['Ingreso por Seguros', 'Comisión que AutoFácil gana por los seguros intermediados (com_rdh + com_cesantia + com_reparaciones). Alimenta el Ingreso Neto Operacional. Si se digita a mano queda forzado (rojo).', 'Cálculos'],
