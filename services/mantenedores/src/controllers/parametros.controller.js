...
const ensureTable = async () => {
  ...
  const defaults = [
    ...
    // ── Tabla actuarial COMPLETA de la aseguradora (combos × bracket) ─────
    // Mantenedor "Factores de Seguros Clientes". El combo drc (paquete completo)
    // lo consume shared/cotizador.js (Simulador Rápido/cotizaciones). NO son la
    // suma de seg_d/r/c (esos solo distribuyen el total del combo).
    ['seg_full_d_6', 0.008980, 'Aseguradora — combo DESG bracket 6m'], ['seg_full_r_6', 0.006745, 'Aseguradora — combo RDH bracket 6m'], ['seg_full_c_6', 0.036162, 'Aseguradora — combo CESANTÍA bracket 6m'], ['seg_full_dr_6', 0.015847, 'Aseguradora — combo DESG+RDH bracket 6m'], ['seg_full_dc_6', 0.045806, 'Aseguradora — combo DESG+CESA bracket 6m'], ['seg_full_rc_6', 0.043406, 'Aseguradora — combo RDH+CESA bracket 6m'], ['seg_full_drc_6', 0.053186, 'Aseguradora — combo DESG+RDH+CESA bracket 6m'],
    ['seg_full_d_12', 0.018641, 'Aseguradora — combo DESG bracket 12m'], ['seg_full_r_12', 0.011634, 'Aseguradora — combo RDH bracket 12m'], ['seg_full_c_12', 0.037883, 'Aseguradora — combo CESANTÍA bracket 12m'], ['seg_full_dr_12', 0.030715, 'Aseguradora — combo DESG+RDH bracket 12m'], ['seg_full_dc_12', 0.057977, 'Aseguradora — combo DESG+CESA bracket 12m'], ['seg_full_rc_12', 0.050420, 'Aseguradora — combo RDH+CESA bracket 12m'], ['seg_full_drc_12', 0.071008, 'Aseguradora — combo DESG+RDH+CESA bracket 12m'],
    ['seg_full_d_24', 0.027538, 'Aseguradora — combo DESG bracket 24m'], ['seg_full_r_24', 0.012248, 'Aseguradora — combo RDH bracket 24m'], ['seg_full_c_24', 0.042101, 'Aseguradora — combo CESANTÍA bracket 24m'], ['seg_full_dr_24', 0.040474, 'Aseguradora — combo DESG+RDH bracket 24m'], ['seg_full_dc_24', 0.072041, 'Aseguradora — combo DESG+CESA bracket 24m'], ['seg_full_rc_24', 0.055409, 'Aseguradora — combo RDH+CESA bracket 24m'], ['seg_full_drc_24', 0.086130, 'Aseguradora — combo DESG+RDH+CESA bracket 24m'],
    ['seg_full_d_36', 0.035518, 'Aseguradora — combo DESG bracket 36m'], ['seg_full_r_36', 0.012761, 'Aseguradora — combo RDH bracket 36m'], ['seg_full_c_36', 0.047120, 'Aseguradora — combo CESANTÍA bracket 36m'], ['seg_full_dr_36', 0.049208, 'Aseguradora — combo DESG+RDH bracket 36m'], ['seg_full_dc_36', 0.086130, 'Aseguradora — combo DESG+CESA bracket 36m'], ['seg_full_rc_36', 0.061121, 'Aseguradora — combo RDH+CESA bracket 36m'], ['seg_full_drc_36', 0.101200, 'Aseguradora — combo DESG+RDH+CESA bracket 36m'],
    ['seg_full_d_48', 0.043623, 'Aseguradora — combo DESG bracket 48m'], ['seg_full_r_48', 0.029018, 'Aseguradora — combo RDH bracket 48m'], ['seg_full_c_48', 0.052853, 'Aseguradora — combo CESANTÍA bracket 48m'], ['seg_full_dr_48', 0.075269, 'Aseguradora — combo DESG+RDH bracket 48m'], ['seg_full_dc_48', 0.101322, 'Aseguradora — combo DESG+CESA bracket 48m'], ['seg_full_rc_48', 0.085069, 'Aseguradora — combo RDH+CESA bracket 48m'], ['seg_full_drc_48', 0.136622, 'Aseguradora — combo DESG+RDH+CESA bracket 48m'],
    ['seg_full_d_72', 0.054964, 'Aseguradora — combo DESG bracket 72m'], ['seg_full_r_72', 0.034875, 'Aseguradora — combo RDH bracket 72m'], ['seg_full_c_72', 0.058985, 'Aseguradora — combo CESANTÍA bracket 72m'], ['seg_full_dr_72', 0.093853, 'Aseguradora — combo DESG+RDH bracket 72m'], ['seg_full_dc_72', 0.120825, 'Aseguradora — combo DESG+CESA bracket 72m'], ['seg_full_rc_72', 0.098177, 'Aseguradora — combo RDH+CESA bracket 72m'], ['seg_full_drc_72', 0.164822, 'Aseguradora — combo DESG+RDH+CESA bracket 72m'],
    ...
    // ── Contraste de la carga masiva contra nuestros datos ────────────────
    ['carga_dif_meses_atras', 1, 'Carga Trinidad — cuántos meses hacia atrás, además del mes en curso, se contrastan contra el archivo (1 = mes actual y el pasado). Los meses viejos ya están cuadrados: revisarlos llena la pantalla de casos que nadie resuelve'],
  ];
