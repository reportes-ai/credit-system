...
(async () => {
  try {
    ...
    if (cnt[0].n === 0) {
      const defaults = [
        ['Carnet de Identidad (Frente)',        null,                            1, 1,  10],
        ['Carnet de Identidad (Reverso)',        null,                            1, 1,  20],
        ['Comprobante de Domicilio',             null,                            1, 1,  30],
        ['Certificado AFP',                      null,                            1, 1,  40],
        ['Certificado RNDPA',                    null,                            1, 1,  50],
        ['Certificado Anotaciones Vigentes',     null,                            1, 1,  60],
        ['Certificado Historia Vehículo',        null,                            1, 1,  70],
        ['Liquidaciones de Sueldo',              'Últimas 3 liquidaciones',       1, 1,  80],
        ['Declaración de Impuestos',             null,                            0, 1,  90],
        ['Referencias',                          null,                            0, 1, 100],
      ];
