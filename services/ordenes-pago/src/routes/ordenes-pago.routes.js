...
router.delete('/ordenes/:id/adjunto/:docId', verifyToken, requireFunc('ordenes_pago_emitir', 'ordenes_pago_historial', 'pagos_recurrentes'), c.quitarRespaldo);   // solo quien emitió, no pagada/anulada (gate en el controller)
