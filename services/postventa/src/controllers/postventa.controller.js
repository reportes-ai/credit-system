...
const ORIGENES_FDOC = ['COMISION', 'PARQUE', 'ODP', 'ODC', 'SEGURO'];   // SEGURO → rh_seguro_pago.id (cupón y nómina de cotización de la aseguradora)   // ODP → ordenes_pago.id · ODC → odc_ordenes.id (Otras Compras)
