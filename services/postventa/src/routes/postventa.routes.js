...
router.post('/factura-doc',       verifyToken, requireFunc('postventa_seguimiento', 'pv_com_orden_emitir', 'pv_parques_emitir', 'ordenes_pago_emitir'), c.subirFacturaDoc);
router.get('/factura-doc',        verifyToken, c.listarFacturaDocs);
router.get('/factura-doc/:id',    verifyToken, c.verFacturaDoc);
router.delete('/factura-doc/:id', verifyToken, requireFunc('postventa_seguimiento', 'pv_com_orden_emitir', 'pv_parques_emitir', 'ordenes_pago_emitir'), c.borrarFacturaDoc);
