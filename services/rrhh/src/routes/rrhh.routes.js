...
router.get('/vacaciones/:id/comprobante', verifyToken, ctrl.comprobanteVacaciones);
router.post('/vacaciones/:id/reenviar-comprobante', verifyToken, requireFunc('rh_aprobar'), ctrl.reenviarComprobante);   // PDF con firmas + QR (dueño, supervisor, RRHH)
...
router.post('/contratos/anexos/modelos/:id/generar', verifyToken, requireFunc('rh_contratos', 'rh_colaboradores'), con.anexoModeloGenerar);
router.get('/contratos/anexos/modelos/:id/texto',    verifyToken, requireFunc('rh_contratos', 'rh_colaboradores'), con.anexoModeloTexto);
router.put('/contratos/anexos/modelos/:id/texto',    verifyToken, requireFunc('rh_contratos', 'rh_colaboradores'), con.anexoModeloTextoGuardar);
...
router.get('/remuneraciones/adicionales/comisiones', verifyToken, requireFunc('rh_remuneraciones'), rem.getComisionesMes);   // pestaña Comisiones del mes
...
router.get('/remuneraciones/seguro/pago',             verifyToken, requireFunc('rh_remuneraciones'), seguro.getPago);
router.post('/remuneraciones/seguro/cupon',           verifyToken, requireFunc('rh_remuneraciones'), seguro.subirCupon);
router.post('/remuneraciones/seguro/cotizacion',      verifyToken, requireFunc('rh_remuneraciones'), seguro.subirCotizacion);
