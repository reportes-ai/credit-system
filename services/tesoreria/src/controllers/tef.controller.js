...
async function filasParques(items) {
  ...
  for (const it of items) {
    ...
    const b = require('../../../../shared/beneficiario-pago').beneficiarioPago({ rut: p?.rut, nombre: p?.razon_social || p?.nombre_cuenta || it.parque, rut_pago: p?.rut_cuenta, nombre_cuenta: p?.nombre_cuenta });
