...
// Suspender (baja lógica): editar/eliminar/gestionar. Borrado definitivo: requiere 'usuarios.eliminar'.
router.delete('/:id', verifyToken, requireFunc('usuarios.editar', 'usuarios.eliminar', 'usuarios_gestionar'), ctrl.deleteUsuario);
