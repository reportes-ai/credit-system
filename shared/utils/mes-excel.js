'use strict';
/* ── Motor único: parsea la columna MES de Excel ("may-26", "2026-05", "05/2026")
   → 'YYYY-MM-01', y calcula el último día de ese mes. Usado por carga-masiva y
   carga-trinidad cuando la fecha real (FECHA OTORGADO/CURSE) no es confiable
   (ej. INDEXA fuerza "hoy" y el período real solo consta en la columna MES). */
